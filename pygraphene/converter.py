...
from pygraphene.fields import PynamoConnectionField
from pygraphene.relationships import OneToOne, OneToMany, Relationship
...
@convert_pynamo_attribute.register(Relationship)
