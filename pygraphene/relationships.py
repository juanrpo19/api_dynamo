...
from pynamodb.constants import STRING, NUMBER, LIST, STRING_SET
from pynamodb.models import Model
from six import string_types
from wrapt import ObjectProxy

from pygraphene.utils import get_key_name
...
class OneToMany(Relationship):
    ...
    def serialize(self, models):
        key_type = getattr(self.model, self.hash_key_name).attr_type
